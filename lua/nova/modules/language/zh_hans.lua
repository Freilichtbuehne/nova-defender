...
https://github.com/Freilichtbuehne/nova-defender-anticheat/releases/latest]],
    ...
    */
    ...
    ["menu_elem_discord"] = "加入我们的 Discord！",
    ["menu_elem_close"] = "关闭",
    ["menu_elem_cancel"] = "取消",
    ...
    ["indicator_cheat_hotkey"] = "玩家按下了一个键（INSERT、HOME、PAGEUP、PAGEDOWN），该键通常用于打开作弊菜单",
    ["indicator_cheat_menu"] = "玩家使用 INSERT、HOME、PAGEUP 或 PAGEDOWN 键之一打开了菜单",
