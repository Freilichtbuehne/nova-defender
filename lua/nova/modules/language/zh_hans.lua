...
请单击菜单顶部的相应按钮或加入我们的 Discord 了解更多信息]],
 ...
 https://github.com/Freilichtbuehne/nova-defender-ddos/releases/latest]],
    ...
    ["menu_elem_ddos_active"] = "服务器遭受 DDoS 攻击！",
    ["menu_elem_ddos_inactive"] = "DDoS 保护已激活 | 没有活跃攻击",
    ...
    ["indicator_fatalmenu"] = "玩家过去使用过或当前正在使用作弊'FatalMenu'",
    ["indicator_imgui"] = "玩家的Garry's Mod文件夹中有imgui.ini文件。许多外部作弊器用它来存储设置。",
    ["indicator_imgui_active"] = "玩家的Garry's Mod文件夹中有imgui.ini文件，并且是在他启动游戏后创建的。许多外部作弊器用它来存储设置。",
