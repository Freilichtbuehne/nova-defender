...
local phrases = {
    ...
    */
    ...
    ["networking_vpn_abuseipdb_report_enabled"] = "Signaler les bans à AbuseIPDB:\nSignaler automatiquement les adresses IP à AbuseIPDB lorsqu'un joueur est banni pour attaques Flood/DoS.",
    ["networking_vpn_abuseipdb_report_flood_categories"] = "Catégories AbuseIPDB pour les signalements Flood/DoS:\nLes ID de catégorie à utiliser pour les signalements. Par défaut: 4 (DoS). Voir https://www.abuseipdb.com/categories.",
