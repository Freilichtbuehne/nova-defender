...
function Nova.sha256_binary(msg)
	return hex_to_binary(Nova.sha256(msg))
end

function Nova.hmac_sha256(key, text)
	if #key > blocksize then
		key = Nova.sha256_binary(key)
	end
	...
	return Nova.sha256(key_xord_with_0x5c .. Nova.sha256_binary(key_xord_with_0x36 .. text))
end